...
const PopularPersons = () => {
  ...
  return (
    ...
    <div className="labelInputInPopularPerson">
        ...
        <input type="number" readOnly min={1} max={250} value={pageidstate} onChange={pageHandler} className='filterinpopuperson'/>
                    ...
                    allpersons.data.map((item)=>{
                        return(
                            <>
                                ...
                                <div className="" >
                                    <Link to={`/person/${item.id}/${item.name}`} className='navlinks'>
